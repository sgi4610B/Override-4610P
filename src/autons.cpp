...
void default_constants() {
  ...
  // Exit conditions
  chassis.pid_turn_exit_condition_set(60_ms, 3_deg, 250_ms, 7_deg, 500_ms, 500_ms);
  chassis.pid_swing_exit_condition_set(90_ms, 3_deg, 250_ms, 7_deg, 500_ms, 500_ms);
  chassis.pid_drive_exit_condition_set(40_ms, 1_in, 250_ms, 3_in, 500_ms, 500_ms);
  chassis.pid_odom_turn_exit_condition_set(90_ms, 3_deg, 250_ms, 7_deg, 500_ms, 750_ms);
  chassis.pid_odom_drive_exit_condition_set(90_ms, 1_in, 250_ms, 3_in, 500_ms, 750_ms);
  chassis.pid_turn_chain_constant_set(3_deg);
  chassis.pid_swing_chain_constant_set(5_deg);
...
void red_right3(){
  ...
  chassis.pid_drive_set(-1.6_in, DRIVE_SPEED);
  chassis.pid_wait();
  pros::delay(100);
  ...
  chassis.pid_turn_set(218_deg, 90);
  chassis.pid_wait();
  ...
  chassis.pid_wait();
  pros::delay(100);
  chassis.pid_drive_set(2.5_in, 6);
  chassis.pid_wait();
  ...
  lift.move(-40);
  chassis.pid_drive_set(-14_in, 75);
  chassis.pid_wait();
  lift.brake();
...
void red_rightRightMid(){
  ...
  chassis.pid_turn_set(220_deg, 90);
  chassis.pid_wait();
...
void red_rightRightCenter(){
  ...
  chassis.pid_drive_set(-1.4_in, DRIVE_SPEED);
  chassis.pid_wait();
  pros::delay(150);
  ...
  chassis.pid_drive_set(3.75_in, 30);
  chassis.pid_wait();
...
void blue_left3(){
  ...
  chassis.pid_drive_set(-1.53_in, DRIVE_SPEED);
  chassis.pid_wait();
  pros::delay(150);
  ...
  chassis.pid_turn_set(-219_deg, 90);
  chassis.pid_wait();
...
void red_rightJustThePreload(){
  ...
  lift.move(-90);
  chassis.pid_drive_set(-1.9_in, DRIVE_SPEED);
  chassis.pid_wait();
  lift.set_brake_mode(MOTOR_BRAKE_HOLD);
  lift.brake();
